...
function(t) {
    ...
    function(t, e, i) {
        ...
        function k(t, e) {
            ...
            e.rotation = a ? L(a.pointers, n) : 0,
            F(i, e);
            var c = t.element;
            m(e.srcEvent.target, c) && (c = e.srcEvent.target),
            e.target = c
        }
        function D(t, e) {
            var i = e.center,
            n = t.offsetDelta || {},
            s = t.prevDelta || {},
            o = t.prevInput || {}; (e.eventType === St || o.eventType === Dt) && (s = t.prevDelta = {
                x: o.deltaX || 0,
                y: o.deltaY || 0
            },
            n = t.offsetDelta = {
        ...
        function q(t, e) {
            ...
            return e & (Dt | Ft) && (i = y(i.concat(n), "identifier", !0)),
            [i, n]
        }
        function W() {
            this.evTarget = Gt,
        ...
        function H(t, e) {
            var i = w(t.touches),
            n = this.targetIds;
            if (e & (St | kt) && 1 === i.length) return n[i[0].identifier] = !0,
            [i, i];
            ...
            if (o = i.filter(function(t) {
                return m(t.target, l)
            }), e === St) for (s = 0; s < o.length;) n[o[s].identifier] = !0,
            s++;
            for (s = 0; s < a.length;) n[a[s].identifier] && r.push(a[s]),
            e & (Dt | Ft) && delete n[a[s].identifier],
            s++;
        ...
        function B() {
            ...
            this.mouse = new _(this.manager, t)
        }
        function U(t, e) {
            this.manager = t,
            this.set(e)
        ...
        function nt(t, e) {
            return e = e || {},
            e.recognizers = h(e.recognizers, nt.defaults.preset),
            new st(t, e)
        }
        function st(t, e) {
            e = e || {},
        ...
        l(_, C, {
            handler: function(t) {
                ...
                e & kt && 1 !== t.which && (e = Dt),
                this.pressed && this.allow && (e & Dt && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: xt,
                    srcEvent: t
        ...
        window.MSPointerEvent && (Ut = "MSPointerDown", Vt = "MSPointerMove MSPointerUp MSPointerCancel"),
        l(z, C, {
            handler: function(t) {
                var e = this.store,
                i = !1,
                ...
                s & St && (0 === t.button || a) ? 0 > r && (e.push(t), r = e.length - 1) : s & (Dt | Ft) && (i = !0),
        ...
        l(R, C, {
            handler: function(t) {
                ...
                if (e === St && (this.started = !0), this.started) {
                    ...
                    e & (Dt | Ft) && i[0].length - i[1].length === 0 && (this.started = !1),
        ...
        l(J, G, {
            ...
            directionTest: function(t) {
                ...
                o = t.deltaX,
                a = t.deltaY;
                return s & e.direction || (e.direction & It ? (s = 0 === o ? At: 0 > o ? $t: Mt, i = o != this.pX, n = Math.abs(t.deltaX)) : (s = 0 === a ? At: 0 > a ? Pt: Nt, i = a != this.pY, n = Math.abs(t.deltaY))),
                t.direction = s,
        ...
        l(Q, X, {
            ...
            process: function(t) {
                ...
                else if (t.eventType & St) this.reset(),
        ...
        l(et, G, {
            ...
            attrTest: function(t) {
                ...
                return i & (It | Lt) ? e = t.velocity: i & It ? e = t.velocityX: i & Lt && (e = t.velocityY),
                this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pt(e) > this.options.velocity && t.eventType & Dt
            },
            emit: function(t) {
                var e = j(t.direction);
                e && this.manager.emit(this.options.event + e, t),
        ...
        st.prototype = {
            ...
            recognize: function(t) {
                ...
                if (!e.stopped) {
                    ...
                    s = e.curRecognizer; (!s || s && s.state & ce) && (s = e.curRecognizer = null);
                    for (var o = 0; o < n.length;) i = n[o],
                    e.stopped === pe || s && i != s && !i.canRecognizeWith(s) ? i.reset() : i.recognize(t),
                    !s && i.state & (ae | re | le) && (s = e.curRecognizer = i),
                    o++
                }
            },
            get: function(t) {
    ...
    function(t, e, i) {
        ...
        a.prototype.fill = function() {
            ...
            h = s.getFullYear(),
            d = s.getMonth(),
            i > d && h === e || e > h ? u += " am-datepicker-old": (d > i && h === e || h > e) && (u += " am-datepicker-new"),
            ...
            n.flexslider = function(t, i) {
                ...
                v = {
                    init: function() {
                        ...
                        s.prop = h ? "top": "marginLeft",
                        s.args = {},
                        s.manualPause = !1,
                        s.stopped = !1,
                        s.started = !1,
                        s.startTimeout = null,
                        s.transitions = !s.vars.video && !m && s.vars.useCSS &&
                        function() {
                        ...
                        s.doMath(),
                        s.setup("init"),
                        s.vars.controlNav && v.controlNav.setup(),
                        s.vars.directionNav && v.directionNav.setup(),
                        ...
                        s.vars.pausePlay && v.pausePlay.setup(),
                        s.vars.slideshow && s.vars.pauseInvisible && v.pauseInvisible.init(),
                        s.vars.slideshow && (s.vars.pauseOnHover && s.hover(function() {
                            s.manualPlay || s.manualPause || s.pause()
                        },
                        function() {
                            s.manualPause || s.manualPlay || s.stopped || s.play()
                        }), s.vars.pauseInvisible && v.pauseInvisible.isHidden() || (s.vars.initDelay > 0 ? s.startTimeout = setTimeout(s.play, s.vars.initDelay) : s.play())),
                        f && v.asNav.setup(),
                        l && s.vars.touch && v.touch(),
                        (!m || m && s.vars.smoothHeight) && n(window).bind("resize orientationchange focus", v.resize),
                    ...
                    asNav: {
                        setup: function() {
                            ...
                            r ? (t._slider = s, s.slides.each(function() {
                                var t = this;
                    ...
                    controlNav: {
                        ...
                        setupPaging: function() {
                            ...
                            v.controlNav.set(),
                            v.controlNav.active(),
                            s.controlNavScaffold.delegate("a, img", c,
                            function(t) {
                        ...
                        update: function(t, e) {
                            s.pagingCount > 1 && "add" === t ? s.controlNavScaffold.append(n("<li><a>" + s.count + "</a></li>")) : 1 === s.pagingCount ? s.controlNavScaffold.find("li").remove() : s.controlNav.eq(e).closest("li").remove(),
                            v.controlNav.set(),
                            s.pagingCount > 1 && s.pagingCount !== s.controlNav.length ? s.update(e, t) : v.controlNav.active()
                        }
                    },
                    directionNav: {
                        setup: function() {
                            ...
                            s.controlsContainer ? (n(s.controlsContainer).append(t), s.directionNav = n("." + a + "direction-nav li a", s.controlsContainer)) : (s.append(t), s.directionNav = n("." + a + "direction-nav li a", s)),
                            v.directionNav.update(),
                            s.directionNav.bind(c,
                            function(t) {
                                t.preventDefault();
                                var e; ("" === u || u === t.type) && (e = n(this).hasClass(a + "next") ? s.getTarget("next") : s.getTarget("prev"), s.flexAnimate(e, s.vars.pauseOnAction)),
                                "" === u && (u = t.type),
                                v.setToClearWatchedEvent()
                            })
                        },
                    ...
                    pausePlay: {
                        setup: function() {
                            ...
                            s.controlsContainer ? (s.controlsContainer.append(t), s.pausePlay = n("." + a + "pauseplay a", s.controlsContainer)) : (s.append(t), s.pausePlay = n("." + a + "pauseplay a", s)),
                            v.pausePlay.update(s.vars.slideshow ? a + "pause": a + "play"),
                            s.pausePlay.bind(c,
                            function(t) {
                                t.preventDefault(),
                                ("" === u || u === t.type) && (n(this).hasClass(a + "pause") ? (s.manualPause = !0, s.manualPlay = !1, s.pause()) : (s.manualPause = !1, s.manualPlay = !0, s.play())),
                                "" === u && (u = t.type),
                                v.setToClearWatchedEvent()
                            })
                        },
                    ...
                    touch: function() {
                        ...
                        function n(t) {
                            ...
                            x = t.touches[0].pageY,
                            w = h ? u - x: u - T,
                            b = h ? Math.abs(w) < Math.abs(T - f) : Math.abs(w) < Math.abs(x - f);
                            var e = 500; (!b || Number(new Date) - y > e) && (t.preventDefault(), !m && s.transitions && (s.vars.animationLoop || (w /= 0 === s.currentSlide && 0 > w || s.currentSlide === s.last && w > 0 ? Math.abs(w) / g + 2 : 1), s.setProps(v + w, "setTouch")))
                        }
                        function o(e) {
                        ...
                        function a(e) {
                            e.stopPropagation(),
                            s.animating ? e.preventDefault() : (s.pause(), t._gesture.addPointer(e.pointerId), C = 0, g = h ? s.h: s.w, y = Number(new Date), v = p && d && s.animatingTo === s.last ? 0 : p && d ? s.limit - (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo: p && s.currentSlide === s.last ? s.limit: p ? (s.itemW + s.vars.itemMargin) * s.move * s.currentSlide: d ? (s.last - s.currentSlide + s.cloneOffset) * g: (s.currentSlide + s.cloneOffset) * g)
                        }
                        function l(i) {
                            i.stopPropagation();
                            ...
                            if (n) {
                                ...
                                return C += h ? o: s,
                                w = C,
                                b = h ? Math.abs(C) < Math.abs( - s) : Math.abs(C) < Math.abs( - o),
                    ...
                    resize: function() { ! s.animating && s.is(":visible") && (p || s.doMath(), m ? v.smoothHeight() : p ? (s.slides.width(s.computedW), s.update(s.pagingCount), s.setProps()) : h ? (s.viewport.height(s.h), s.setProps(s.h, "setTotal")) : (s.vars.smoothHeight && v.smoothHeight(), s.newSlides.width(s.computedW), s.setProps(s.computedW, "setTotal")))
                    },
                ...
                s.flexAnimate = function(t, e, i, o, r) {
                    if (s.vars.animationLoop || t === s.currentSlide || (s.direction = t > s.currentSlide ? "next": "prev"), f && 1 === s.pagingCount && (s.direction = s.currentItem < t ? "next": "prev"), !s.animating && (s.canAdvance(t, r) || i) && s.is(":visible")) {
                        if (f && o) {
                            ...
                            if (s.atEnd = 0 === t || t === s.count - 1, c.flexAnimate(t, !0, !1, !0, r), s.direction = s.currentItem < t ? "next": "prev", c.direction = s.direction, Math.ceil((t + 1) / s.visible) - 1 === s.currentSlide || 0 === t) return s.currentItem = t,
                            s.slides.removeClass(a + "active-slide").eq(t).addClass(a + "active-slide"),
                            !1;
                            s.currentItem = t,
                            s.slides.removeClass(a + "active-slide").eq(t).addClass(a + "active-slide"),
                        ...
                        s.vars.animationSpeed, s.vars.easing, s.wrapup));
                            ...
                            p ? (u = s.vars.itemMargin, w = (s.itemW + u) * s.move * s.animatingTo, g = w > s.limit && 1 !== s.visible ? s.limit: w) : g = 0 === s.currentSlide && t === s.count - 1 && s.vars.animationLoop && "next" !== s.direction ? d ? (s.count + s.cloneOffset) * y: 0 : s.currentSlide === s.last && 0 === t && s.vars.animationLoop && "prev" !== s.direction ? d ? 0 : (s.count + 1) * y: d ? (s.count - 1 - t + s.cloneOffset) * y: (t + s.cloneOffset) * y,
                            s.setProps(g, "", s.vars.animationSpeed),
                ...
                s.wrapup = function(t) {
                    m || p || (0 === s.currentSlide && s.animatingTo === s.last && s.vars.animationLoop ? s.setProps(t, "jumpEnd") : s.currentSlide === s.last && 0 === s.animatingTo && s.vars.animationLoop && s.setProps(t, "jumpStart")),
                    s.animating = !1,
                    s.currentSlide = s.animatingTo,
                    s.vars.after(s)
                },
                s.animateSlides = function() { ! s.animating && g && s.flexAnimate(s.getTarget("next"))
                },
                s.pause = function() {
                    clearInterval(s.animatedSlides),
                    s.animatedSlides = null,
                    s.playing = !1,
                    s.vars.pausePlay && v.pausePlay.update("play"),
                    s.syncExists && v.sync("pause")
                },
                s.play = function() {
                    ...
                    s.vars.pausePlay && v.pausePlay.update("pause"),
                    s.syncExists && v.sync("play")
                },
                s.stop = function() {
                    s.pause(),
                    s.stopped = !0
                ...
                s.setProps = function(t, e, i) {
                    ...
                    s.transitions && (n = h ? "translate3d(0," + n + ",0)": "translate3d(" + n + ",0,0)", i = void 0 !== i ? i / 1e3 + "s": "0s", s.container.css("-" + s.pfx + "-transition-duration", i), s.container.css("transition-duration", i)),
                    s.args[s.prop] = n,
                ...
                s.setup = function(t) {
                    ...
                    s.vars.smoothHeight && v.smoothHeight();
                        ...
                        "init" === t && (s.viewport = n('<div class="' + a + 'viewport"></div>').css({
                            overflow: "hidden",
                            position: "relative"
                        }).appendTo(s).append(s.container), s.cloneCount = 0, s.cloneOffset = 0, d && (i = n.makeArray(s.slides).reverse(), s.slides = n(i), s.container.empty().append(s.slides))),
                        s.vars.animationLoop && !p && (s.cloneCount = 2, s.cloneOffset = 1, "init" !== t && s.container.find(".clone").remove(), s.container.append(v.uniqueID(s.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(v.uniqueID(s.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
                        s.newSlides = n(s.vars.selector, s),
                        e = d ? s.count - 1 - s.currentSlide + s.cloneOffset: s.currentSlide + s.cloneOffset,
                        h && !p ? (s.container.height(200 * (s.count + s.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
                            s.newSlides.css({
                                display: "block"
                            }),
                            s.doMath(),
                    ...
                    p || s.slides.removeClass(a + "active-slide").eq(s.currentSlide).addClass(a + "active-slide"),
                    s.vars.init(s)
                },
                s.doMath = function() {
                    ...
                    p ? (s.itemT = s.vars.itemWidth + e, s.minW = i ? i * s.itemT: s.w, s.maxW = n ? n * s.itemT - e: s.w, s.itemW = s.minW > s.w ? (s.w - e * (i - 1)) / i: s.maxW < s.w ? (s.w - e * (n - 1)) / n: s.vars.itemWidth > s.w ? s.w: s.vars.itemWidth, s.visible = Math.floor(s.w / s.itemW), s.move = s.vars.move > 0 && s.vars.move < s.visible ? s.vars.move: s.visible, s.pagingCount = Math.ceil((s.count - s.visible) / s.move + 1), s.last = s.pagingCount - 1, s.limit = 1 === s.pagingCount ? 0 : s.vars.itemWidth > s.w ? s.itemW * (s.count - 1) + e * (s.count - 1) : (s.itemW + e) * s.count - s.w - e) : (s.itemW = s.w, s.pagingCount = s.count, s.last = s.count - 1),
                    s.computedW = s.itemW - s.boxPadding
                },
                s.update = function(t, e) {
                    s.doMath(),
                    p || (t < s.currentSlide ? s.currentSlide += 1 : t <= s.currentSlide && 0 !== t && (s.currentSlide -= 1), s.animatingTo = s.currentSlide),
                    s.vars.controlNav && !s.manualControls && ("add" === e && !p || s.pagingCount > s.controlNav.length ? v.controlNav.update("add") : ("remove" === e && !p || s.pagingCount < s.controlNav.length) && (p && s.currentSlide > s.last && (s.currentSlide -= 1, s.animatingTo -= 1), v.controlNav.update("remove", s.last))),
                    s.vars.directionNav && v.directionNav.update()
                },
                s.addSlide = function(t, e) {
                    var i = n(t);
                    s.count += 1,
                    s.last = s.count - 1,
                    h && d ? void 0 !== e ? s.slides.eq(s.count - e).after(i) : s.container.prepend(i) : void 0 !== e ? s.slides.eq(e).before(i) : s.container.append(i),
                    s.update(e, "add"),
                ...
                s.removeSlide = function(t) {
                    ...
                    s.count -= 1,
                    s.last = s.count - 1,
                    isNaN(t) ? n(t, s.slides).remove() : h && d ? s.slides.eq(s.last).remove() : s.slides.eq(t).remove(),
                    s.doMath(),
                    s.update(e, "remove"),
                    s.slides = n(s.vars.selector + ":not(.clone)", s),
                    s.setup(),
    ...
    function(t, e, i) {
        ...
        var s = i(2),
        o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
        function(t) {
    ...
    function(t, e, i) {
        ...
        c.prototype.open = function(t) {
            ...
            if (!this.active && this.$element.length) {
                ...
                this.dimmer.open(e),
                e.show().redraw(),
                n || this.isActions || (o && (o = parseInt(o, 10), r.width = o + "px", r.marginLeft = -parseInt(o / 2) + "px"), a ? (a = parseInt(a, 10), r.marginTop = -parseInt(a / 2) + "px", this.$dialog.css({
                    height: a + "px"
                })) : r.marginTop = -parseInt(e.height() / 2, 10) + "px", e.css(r)),
    ...
    function(t, e, i) {
        ...
        a.prototype.sizePopover = function() {
            ...
            if (e && e.length) {
                ...
                r - g < h.top + g ? m = u.top - r - g: r < d - h.top - h.height ? (w = "bottom", m = u.top + c + a + g) : (w = "middle", m = c / 2 + u.top - n / 2),
                "top" === w || "bottom" === w ? (f = l / 2 + u.left - i / 2, v = f, 5 > f && (f = 5), f + i > p && (f = p - i - 20), "top" === w && e.addClass("am-popover-top"), "bottom" === w && e.addClass("am-popover-bottom"), v -= f) : "middle" === w && (f = u.left - i - a, e.addClass("am-popover-left"), 5 > f && (f = u.left + l + a, e.removeClass("am-popover-left").addClass("am-popover-right")), f + i > p && (f = p - i - 5, e.removeClass("am-popover-left").addClass("am-popover-right"))),
                e.css({
                    top: m + "px",
                    left: f + "px"
                })
    ...
    function(t, e, i) {
        ...
        o.DEFAULTS = {
            ...
            searchBox: !1,
            tpl: '<div class="col-md-12  clear-both <%= dropUp ? \'am-dropdown-up\': \'\' %>" id="<%= id %>" data-am-dropdown>  <button type="button" class="am-selected-btn am-btn am-dropdown-toggle">    <span class="am-selected-status am-fl"></span>    <i class="am-selected-icon am-icon-caret-<%= dropUp ? \'up\' : \'down\' %>"></i>  </button>  <div class="am-selected-content am-dropdown-content">    <h2 class="am-selected-header"><span class="am-icon-chevron-left">\u8fd4\u56de</span></h2>   <% if (searchBox) { %>   <div class="am-selected-search">     <input autocomplete="off" class="am-form-field am-input-sm" />   </div>   <% } %>    <ul class="am-selected-list">      <% for (var i = 0; i < options.length; i++) { %>       <% var option = options[i] %>       <% if (option.header) { %>  <li data-group="<%= option.group %>" class="am-selected-list-header">       <%= option.text %></li>       <% } else { %>       <li class="<%= option.classNames%>"          data-index="<%= option.index %>"          data-group="<%= option.group || 0 %>"          data-value="<%= option.value %>" >         <span class="am-selected-text"><%= option.text %></span></li>      <% } %>      <% } %>    </ul>    <div class="am-selected-hint"></div>  </div></div>',
    ...
    function(t, e, i) {
        ...
        d = function(t) {
            ...
            for (var e = null,
            i = 0,
            n = h.length; n > i; i++) if (h[i].text == this.options.text && h[i].text.correctLevel == this.options.correctLevel) {
                e = h[i].obj;
                break
            }
        ...
        o.prototype = {
            ...
            createBytes: function(t) {
                ...
                o = new Array,
                r = 0; s > r; r++) for (var l = this.rsBlock[3 * r + 0], c = this.rsBlock[3 * r + 1], u = this.rsBlock[3 * r + 2], h = 0; l > h; h++) o.push([u, c]);
    ...
    function(t, e, i) {
        ...
        o.DEFAULTS = {
            ...
            checkboxTpl: '<span class="am-ucheck-icons"><i class="am-icon-unchecked"></i></span>',
            radioTpl: '<span class="am-ucheck-icons"><i class="am-icon-unchecked"></i></span>'
        },
        o.prototype.init = function() {
            var t = this.$element,
            e = t[0],
    ...
    function(t, e, i) {
        ...
        o.prototype.validate = function(t) {
            ...
            g.valueMissing = !0;
                ...
                y = parseInt(o.attr("maxchecked"), 10); ! isNaN(w) && w > h && (g.valid = !1, g.customError = "checkedUnderflow"),
                !isNaN(y) && h > y && (g.valid = !1, g.customError = "checkedOverflow")
