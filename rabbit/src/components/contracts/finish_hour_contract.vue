          ...
          <div class="modal-body yzj-box yzj-height20 yzj-top-distance10">
            ...
            <div class="yzj-size-16 yzj-top-distance50" style="padding-left:100px;padding-right: 100px;">
              <div v-if="contract.status == 'carry'">
                ...
                <div v-if="contract.stones[contract.stones.length-1].shot_times > 0">
                  <p class="yzj-top-distance20">本周服务方已完成工作<span v-html="contract.stones[contract.stones.length-1].shot_times | hourformat"></span>小时，按照¥ <span v-html="contract.hourly"></span>/小时计算，需支付<span v-html="'￥' + (contract.stones[contract.stones.length-1].shot_times/60*contract.hourly).toFixed(2)"></span>，是否同意支付已完成工作的费用？</p>
                {[(stone.shot_times/60*contract.hourly).toFixed(2)]}
